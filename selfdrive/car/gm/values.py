...
FINGERPRINTS = {
  ...
  # Bolt EV Premier 2017 w Pedal ## under keys are python-grammar wrong keys
  # {
...
DBC = {
  ...
  CAR.BOLT: dbc_dict('gm_global_a_powertrain', None, body_dbc='gm_global_a_lowspeed_1818125'),
}
