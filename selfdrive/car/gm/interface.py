...
class CarInterface(CarInterfaceBase):
    ...
    def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=None):
        ...
        ret.steerActuatorDelay = 0.225  # def: 0.2 Default delay, not measured yet
    ...
    def update(self, c, can_strings):
        ...
        if not self.flag_pcmEnable_initialSet and (
                ret.gearShifter == GearShifter.park or ret.gearShifter == GearShifter.reverse or (
                ret.brakePressed and ret.vEgo < 1)):
            self.flag_pcmEnable_initialSet = True
