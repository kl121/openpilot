...
DevicePanel::DevicePanel(QWidget* parent) : QWidget(parent) {
  ...
  device_layout->addWidget(new ButtonControl("Reset Calibration", "RESET",
                                             "openpilot requires the device to be mounted within 4¡Æ left or right and within 5¡Æ up or down. openpilot is continuously calibrating, resetting is rarely required.",
                                             [=]() {
